...
// binding.contentMain.recyclerview remplace findViewById(R.id.recyclerview)
        ...
        LinkedList<Word> finalMWordList = mWordList;
        binding.fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int wordListSize =  finalMWordList.size();

                // Ajoutez un nouveau mot à la liste de mots.
                finalMWordList.addLast(new Word("+ Word " + wordListSize));
